...
import Navbar from './project-fullWebsite/menu/Navbar';
import About from './project-fullWebsite/pages/About';
import Contact from './project-fullWebsite/pages/Contact';
import Footer from './project-fullWebsite/pages/Footer';
import Home from './project-fullWebsite/pages/Home';
import Service from './project-fullWebsite/pages/Service';
import './project-fullWebsite/style/index.css';
